...
urlpatterns = patterns('blog.views',
    ...
    url(r'^gallery$', views.albums_view, name='albums_view'),
    url(r'^gallery/(?P<album_id>\d+)/photos$', views.album_photos_view,
        name='album_photos_view'),
    url(r'^gallery/(?P<album_id>\d+)/photos/(?P<photo_id>\d+)$',
        views.photo_view, name='photo_view'),
    url(r'^fixtures$', views.tournaments_list, name="tournaments_view"),
    url(r'^fixtures/(?P<tournament_id>\d+)$', views.tournament,
